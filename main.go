...
var CLI struct {
	...
	List               ListCmd               `cmd:"" help:"List all windows. The data is returned as tab-separated rows containing the UUID, resourceClass and resourceName. Each window is represented by a separate row."`
