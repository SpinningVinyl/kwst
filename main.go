...
var CLI struct {
    ...
    List ListCmd `cmd:"" help:"List all windows"`
    ...
    GetWindowGeometry GetWindowGeometryCmd `cmd:"" help:"Get the geometry (size and position) of the window with the specified UUID"`
    ...
    SetWindowSize SetWindowSizeCmd `cmd:"" help:"Set the size of the window with the provided UUID to the specified values"`
